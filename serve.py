...
class CORSFile(File):
    def render_GET(self, request):
        ...
        logging.info('GET %s', request.path)
...
class TranscriptionsController(Resource):
    ...
    def getChild(self, uid, req):
        ...
        # Add CORSFile for align.json
        trans_ctrl.putChild(b"align.json", CORSFile(os.path.join(out_dir, 'align.json')))
    ...
    def render_POST(self, req):
        ...
        response = json.dumps({"uid": uid}).encode()
